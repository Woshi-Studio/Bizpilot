...
export default function TermsPage() {
  return (
    <article>
      ...
      <h2>2. Your data is yours</h2>
      <p>
        Everything you enter — customers, transactions, notes, documents —
        belongs to you. We store it only to provide the service, and you can
      ...
      <p>
        AI features can make mistakes. Review AI-generated messages,
        summaries, and numbers before sending or relying on them. You are
      ...
      <h2>7. Changes</h2>
      <p>
        We may update these terms as the product evolves. Meaningful changes
